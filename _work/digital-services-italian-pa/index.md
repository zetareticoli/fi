---
layout: work
title: Digital Services for the Italian Public Administration
...
activities:
  - label: Functional requirements — wrote and maintained functional specifications for each template, and verified that external suppliers implemented them correctly.
  - label: Information architecture — designed sitemaps, navigation structures, and content models tailored to each institution type.
  - label: Product Design — designed mid-fidelity and high-fidelity layouts and UI kits in Figma, built on the national design system (Design System Italia).
  - label: Usability and accessibility testing — planned and conducted in-person and remote testing sessions with real users; validated components against legal accessibility requirements.
  - label: Development resources — implemented static HTML templates and CMS themes to make the compliant path the easiest one for agencies and developers to follow.
  - label: Collaborated with policy makers, civil servants, and the web agencies responsible for actual site delivery
outcomes:
  - number: "4"
...
tools:
  ...
  - Miro
images:
  - /img/work/digital-services-italian-pa/digital-services-italian-pa-1.jpg
  - /img/work/digital-services-italian-pa/digital-services-italian-pa-1.jpg
  - /img/work/digital-services-italian-pa/digital-services-italian-pa-1.jpg
permalink: /work/digital-services-italian-pa/
---
