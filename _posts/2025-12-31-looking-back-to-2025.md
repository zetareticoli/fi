...
- **[Interface Inventory Workshop](/workshops/interface-inventory)** as a way to *see* the product for what it really is
- **[Design Tokens Workshop](/workshops/design-tokens)** as a shared language between design and code
...
![Stage photo of the talk about accessibility and Design System Italia](/img/posts/accessibility-days-2025-francesco-improta-talk.webp)
...
**See the full talk on → [YouTube](https://www.youtube.com/watch?v=5fcr87LmGOs)**.
...
**[Read Designabile →](https://designabile.substack.com/)**

**[Read Design Tokens Pills →](https://designtokens.substack.com/)**
