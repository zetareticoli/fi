...
<section class="scroll-mt-32 lg:scroll-mt-24 px-6 lg:px-10 py-12 lg:py-16" id="details">
  <div class="mx-auto max-w-5xl">
    ...
    <div class="flex flex-col gap-0.5 mb-12">
      <details class="group border-l-2 border-border open:border-l-accent bg-secondary/40 hover:bg-secondary/60 transition-colors" open>
        ...
        <div class="px-6 pb-6">
          <ul class="flex flex-col gap-2 m-0 p-0 list-none">
            ...
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Definizione approfondita dei design tokens nel contesto dei moderni sistemi di design</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Evoluzione dai valori hardcoded ai design tokens: storia e contesto</li>
      ...
      <details class="group border-l-2 border-border open:border-l-accent bg-secondary/40 hover:bg-secondary/60 transition-colors">
        ...
        <div class="px-6 pb-6">
          <ul class="flex flex-col gap-2 m-0 p-0 list-none">
            <li class="meta-tag">Argomenti</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Architettura a livelli: global, alias e component tokens</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Design tokens systems: color, typography, spacing, icon</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Gestire la specificità</li>
      ...
      <details class="group border-l-2 border-border open:border-l-accent bg-secondary/40 hover:bg-secondary/60 transition-colors">
        ...
        <div class="px-6 pb-6">
          <ul class="flex flex-col gap-2 m-0 p-0 list-none">
            <li class="meta-tag">Argomenti</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Come costruire una tassonomia di vocaboli</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Le caratteristiche di un buon nome</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Creare nomi memorabili</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Convenzioni di scrittura</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Specifiche W3C e standard emergenti</li>
      ...
      <details class="group border-l-2 border-border open:border-l-accent bg-secondary/40 hover:bg-secondary/60 transition-colors">
        ...
        <div class="px-6 pb-6">
          <ul class="flex flex-col gap-2 m-0 p-0 list-none">
            <li class="meta-tag">Argomenti</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Flusso di lavoro completo: dalla definizione all'implementazione</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Usare i design tokens in Figma</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Demo: esportazione e gestione tramite Style Dictionary</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Strategie per la collaborazione designer-developer</li>
      ...
      <details class="group border-l-2 border-border open:border-l-accent bg-secondary/40 hover:bg-secondary/60 transition-colors">
        ...
        <div class="px-6 pb-6">
          <ul class="flex flex-col gap-2 m-0 p-0 list-none">
            <li class="meta-tag">Argomenti</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Tecniche di trasformazione da JSON a CSS tramite Style Dictionary</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Media queries e tokens: gestione responsive</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Gestire temi e dark mode con i design tokens e CSS</li>
      ...
      <details class="group border-l-2 border-border open:border-l-accent bg-secondary/40 hover:bg-secondary/60 transition-colors">
        ...
        <div class="px-6 pb-6">
          <ul class="flex flex-col gap-2 m-0 p-0 list-none">
            <li class="meta-tag">Argomenti</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Modello di governance: chi fa cosa</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Gestire aggiornamenti e rilasci</li>
            <li class="text-sm text-muted-foreground"><span class="text-accent" aria-hidden="true">¬</span> Versionamento semantico</li>
    ...
    <div class="mb-12">
      ...
      <h4 class="font-heading text-xl font-semibold mb-6">Cosa Include</h4>
...
<!-- Instructor Section -->
<section class="scroll-mt-32 lg:scroll-mt-24 bg-secondary/40 px-6 lg:px-10 py-12 lg:py-16" id="teacher">
  <div class="mx-auto max-w-5xl">
    ...
    <div class="flex flex-col gap-4 max-w-3xl">
      <p class="text-lg font-medium leading-relaxed">👋 Ciao! Sono un designer con oltre 20 anni di esperienza nella progettazione di prodotti digitali, specializzato in Design System.</p>
      <p class="text-base text-muted-foreground leading-relaxed">Ho creato questo workshop per <strong class="font-medium text-foreground">aiutarti a comprendere i design tokens e ad applicarli in modo efficace</strong>, riducendo i tempi e migliorando la qualità del prodotto.</p>
      <p class="text-base text-muted-foreground leading-relaxed">Durante il workshop, <strong class="font-medium text-foreground">condividerò esperienze pratiche e strumenti</strong> che ho utilizzato in anni di lavoro su progetti di varia natura.</p>
      <p>
        <a href="/about" class="text-sm underline underline-offset-2 hover:opacity-70 transition-opacity">Qualcosa in più su di me →</a>
      </p>
    </div>
  </div>
</section>
